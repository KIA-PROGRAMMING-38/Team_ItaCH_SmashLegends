...
public class PlayerFirstAttackState : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        _playerInput.isFirstAttack = true;
    }


    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if(_playerInput.isSecondAttack && animator.GetCurrentAnimatorStateInfo(0).normalizedTime <= 0.8f)
        {
        ...
        else if (animator.GetCurrentAnimatorStateInfo(0).normalizedTime >= 0.9f)
        {
            ...
            _playerInput.isFirstAttack = false;
        }
    }
