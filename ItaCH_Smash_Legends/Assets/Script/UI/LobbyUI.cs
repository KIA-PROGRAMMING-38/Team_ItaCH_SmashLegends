...
public class LobbyUI : MonoBehaviour
{
    ...
    {        
        SetUserName();
        SetPanelAndButton(ResourcesPath.LegendMenuUIPath, ResourcesPath.LegendMenuButtonPath);
        SetPanelAndButton(ResourcesPath.SettingUIPath, ResourcesPath.SettingButtonPath);
        SetPanelAndButton(ResourcesPath.MatchingUIPath, ResourcesPath.MatchingButtonPath);
    ...
    private void SetPanelAndButton(string panelPath, string buttonPath)
    {
        ...
        if (buttonPath == ResourcesPath.MatchingButtonPath)
        {
