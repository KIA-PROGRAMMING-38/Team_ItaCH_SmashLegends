...
public static class AnimationHash
{
    ...
    public readonly static int DownIdle = Animator.StringToHash("DownIdle");
    public readonly static int StartIdle = Animator.StringToHash("StartIdle");
    public readonly static int Run = Animator.StringToHash("Run");
    public readonly static int FirstAttack = Animator.StringToHash("FirstAttack");
    ...
    public readonly static int FirstJumpAttack = Animator.StringToHash("FirstJumpAttack");
    public readonly static int SecondJumpAttack = Animator.StringToHash("SecondJumpAttack");
    ...
    public readonly static int RollHitUp = Animator.StringToHash("RollHitUp");
    public readonly static int RollUpFront = Animator.StringToHash("RollUpFront");
